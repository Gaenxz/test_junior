 ...
 */
namespace Magenest\Rules\DB\DataConverter;
 ...
 */
class ConvertJsontoSerialize implements DataConverterInterface
{
    /**
     * @var Serialize
     */
    ...
    public function convert($value)
    {
        if ($this->isValidJsonValue($value)) {
            return $this->serializeValue($this->jsondecodeValue($value));
        }
        return $value;
    }
